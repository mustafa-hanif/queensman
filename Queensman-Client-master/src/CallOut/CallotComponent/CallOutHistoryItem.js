...
export default class CallOutHistoryItem extends React.Component {
  ...
  async componentDidMount() {
    ...
    axios
      .get(link)
      .then((result) => {
        const { length } = result.data.server_response;
        console.log(length);
        for (i = 0; i < length; i++) {
  ...
  SaveResponcePress = () => {
    ...
    axios
      .get(link)
      .then((result) => console.log(result.data.server_responce))
      .catch((error) => console.log(error));
    this.setState({ isRateModalVisible: !this.state.isRateModalVisible });
      ...
      <View style={styles.container}>
            ...
            <List>
              <View style={{ alignSelf: "center" }}>
                <Text style={[styles.TextFam, { fontSize: 17, fontWeight: "bold" }]}>
                  {this.state.HistoryCallOutData.Client_property.address}
                </Text>
                <Text style={[styles.TextFam, { fontSize: 10, color: "#aaa" }]}>
                  {this.state.HistoryCallOutData.Client_property.community},
                  {this.state.HistoryCallOutData.Client_property.city},
                  {this.state.HistoryCallOutData.Client_property.country}
                </Text>
              </View>
              <ListItem />
              <ListItem>
                <Row>
                  ...
                  <Right>
                    <Text style={styles.TextFam}>{this.state.HistoryCallOutData.Client_property.id}</Text>
                  </Right>
                </Row>
              </ListItem>
              ...
              <ListItem>
                <Row>
                  ...
                  <Text style={[styles.TextFam, { alignSelf: "flex-end" }]}>
                    {this.state.HistoryCallOutData.Client_property.status}
                  </Text>
                </Row>
              </ListItem>
              <ListItem>
                  ...
                  <View style={{ flexDirection: "row", alignItems: "center", alignSelf: "flex-end" }}>
                    ...
                    <Icon
                      ...
                      style={{
                        fontSize: 24,
                        color:
                          this.state.HistoryCallOutData.Client_property.urgency_level == "High"
                            ? "red"
                            : this.state.HistoryCallOutData.Client_property.urgency_level == "Scheduled"
                            ? "#aaa"
                            : "#FFCA5D",
                      }}
                    />
              ...
              <ListItem>
                <Row>
                  ...
                  <Text style={[styles.TextFam, { alignSelf: "flex-end" }]}>
                    {this.state.HistoryCallOutData.Client_property.request_time}
                  </Text>
                </Row>
              </ListItem>
              ...
              <ListItem>
                <Row>
                  <Left>
                    <Text style={[styles.TextFam, { color: "#8c8c8c" }]}>Resolved Time</Text>
                  </Left>
                  <Text style={[styles.TextFam, { alignSelf: "flex-end" }]}>
                    {this.state.HistoryCallOutData.Client_property.resolved_time}
                  </Text>
                </Row>
              </ListItem>
              <ListItem>
                <Row>
                  ...
                  <Text style={[styles.TextFam, { alignSelf: "flex-end" }]}>
                    {this.state.HistoryCallOutData.Client_property.planned_time == null
                      ? "N/A"
                      : this.state.HistoryCallOutData.Client_property.planned_time}
                  </Text>
                </Row>
              </ListItem>
              <ListItem>
                <Col>
                  ...
                  <Text style={styles.TextFam}>{this.state.HistoryCallOutData.Client_property.description}</Text>
                </Col>
              </ListItem>
              ...
              <ListItem>
                <Col>
                  <Row>
                    <Text style={[styles.TextFam, { fontWeight: "bold" }]}>Status</Text>
                  </Row>
                  <Row>
                    <Text style={[styles.TextFam]}>Job Assigned</Text>
                  </Row>
                  <Row>
                    <Text style={[styles.TextFam]}>In Progress</Text>
                  </Row>
                  <Row>
                    <Text style={[styles.TextFam]}>Closed</Text>
                  </Row>
                </Col>

                <Col>
                  <Row>
                    <Text style={[styles.TextFam, { fontWeight: "bold" }]}> Time of Update</Text>
                  </Row>
                  <Row>
                    <Text style={[styles.TextFam]}>
                      {" "}
                      {this.state.status_update_list.length > 0 ? this.state.status_update_list[0].time : "N/A"}
                    </Text>
                  </Row>
                  <Row>
                    <Text style={[styles.TextFam]}>
                      {" "}
                      {this.state.status_update_list.length > 1 ? this.state.status_update_list[1].time : "N/A"}
                    </Text>
                  </Row>
                  <Row>
                    <Text style={[styles.TextFam]}>
                      {" "}
                      {this.state.status_update_list.length > 2 ? this.state.status_update_list[2].time : "N/A"}
                    </Text>
                  </Row>
                </Col>
                ...
                <Col>
                  <Row>
                    <Text style={[styles.TextFam, { fontWeight: "bold" }]}> Updated by</Text>
                  </Row>
                  <Row>
                    <Text style={[styles.TextFam]}>
                      {" "}
                      {this.state.status_update_list.length > 0 ? this.state.status_update_list[0].updated_by : "N/A"}
                    </Text>
                  </Row>
                  <Row>
                    <Text style={[styles.TextFam]}>
                      {" "}
                      {this.state.status_update_list.length > 0 ? this.state.status_update_list[1].updated_by : "N/A"}
                    </Text>
                  </Row>
                  <Row>
                    <Text style={[styles.TextFam]}>
                      {" "}
                      {this.state.status_update_list.length > 0 ? this.state.status_update_list[2].updated_by : "N/A"}
                    </Text>
                  </Row>
                </Col>
              </ListItem>
              <ListItem>
                <Col>
                  <Text style={[styles.TextFam, { color: "#8c8c8c" }]}>Callout Pictures</Text>
                  <Text> </Text>
                  <Row>
                    <TouchableOpacity
                      onPress={() =>
                        this.toggleGalleryEventModal(this.state.HistoryCallOutData.Client_property.picture1)
                      }
                    >
                      <Image
                        style={styles.ImageStyle}
                        source={{ uri: this.state.HistoryCallOutData.Client_property.picture1 }}
                        resizeMode="contain"
                      />
                    </TouchableOpacity>
                    <Text> </Text>
                    <TouchableOpacity
                      onPress={() =>
                        this.toggleGalleryEventModal(this.state.HistoryCallOutData.Client_property.picture2)
                      }
                    >
                      <Image
                        style={styles.ImageStyle}
                        source={{ uri: this.state.HistoryCallOutData.Client_property.picture2 }}
                        resizeMode="contain"
                      />
                    </TouchableOpacity>
                    <Text> </Text>
                  ...
                  <Row>
                    <TouchableOpacity
                      onPress={() =>
                        this.toggleGalleryEventModal(this.state.HistoryCallOutData.Client_property.picture3)
                      }
                    >
                      <Image
                        style={styles.ImageStyle}
                        source={{ uri: this.state.HistoryCallOutData.Client_property.picture3 }}
                        resizeMode="contain"
                      />
                    </TouchableOpacity>
                    <Text> </Text>
                    <TouchableOpacity
                      onPress={() =>
                        this.toggleGalleryEventModal(this.state.HistoryCallOutData.Client_property.picture4)
                      }
                    >
                      <Image
                        style={styles.ImageStyle}
                        source={{ uri: this.state.HistoryCallOutData.Client_property.picture4 }}
                        resizeMode="contain"
                      />
                    </TouchableOpacity>
                    <Text> </Text>
              ...
              <ListItem>
                <Col>
                  <Text style={[styles.TextFam, { color: "#8c8c8c" }]}>Assigned Ops Team</Text>
                  <FlatList
                    data={this.state.workerList}
                    renderItem={({ item }) => (
                      <Row>
                        <Left>
                          <Text style={[styles.TextFam, { color: "#000" }]}>{item.worker_name}</Text>
                        </Left>
              ...
              <ListItem>
                <Col>
                  <Text style={[styles.TextFam, { color: "#8c8c8c" }]}>Pre Job Pictures</Text>
                  <FlatList
                    ...
                    renderItem={({ item }) => (
                      <View style={{ flex: 1, flexDirection: "column", margin: 1 }}>
                        <TouchableOpacity onPress={() => this.toggleGalleryEventModal(item.picture_location)}>
                          <Image
                            style={styles.ImageStyle}
                            source={{ uri: item.picture_location }}
                            resizeMode="contain"
                          />
                        </TouchableOpacity>
                      </View>
              ...
              <ListItem>
                <Col>
                  <Text style={[styles.TextFam, { color: "#8c8c8c" }]}>Post Job Pictures</Text>
                  <FlatList
              ...
              <ListItem>
                <Col>
                  <Text style={[styles.TextFam, { color: "#8c8c8c" }]}>Action</Text>
                  <Text style={styles.TextFam}>{this.state.HistoryCallOutData.Client_property.action}</Text>
                </Col>
              </ListItem>
              <ListItem>
                <Col>
                  <Text style={[styles.TextFam, { color: "#8c8c8c" }]}>Solution</Text>
                  <Text style={styles.TextFam}>{this.state.HistoryCallOutData.Client_property.solution}</Text>
                </Col>
              </ListItem>
              <ListItem>
                <Col>
                  <Text style={[styles.TextFam, { color: "#8c8c8c" }]}>Instructions from Admin</Text>
                  <Text style={styles.TextFam}>{this.state.HistoryCallOutData.Client_property.instructions}</Text>
                </Col>
              </ListItem>
              <ListItem>
                <Col>
                  <Text style={[styles.TextFam, { color: "#8c8c8c" }]}>Feedback</Text>
                  <Text style={styles.TextFam}>{this.state.HistoryCallOutData.Client_property.feedback}</Text>
                </Col>
              </ListItem>
              <ListItem>
                <Row>
                  <Left>
                    <Text style={[styles.TextFam, { color: "#8c8c8c" }]}>Work Rating</Text>
                  </Left>
                  <View style={{ alignSelf: "flex-end", flexDirection: "row" }}>
                    <Text style={styles.TextFam}>{this.state.HistoryCallOutData.Client_property.rating}</Text>
                    <StarRating disabled maxStars={1} rating={3} fullStarColor="#000" starSize={17} />
                  </View>
                </Row>
              </ListItem>
            </List>
        ...
        >
          <View style={styles.rateModel}>
            <Text style={[styles.TextFam, { fontSize: 24, color: "gray" }]}>Rate the Job</Text>
            <Text style={[styles.TextFam, { fontSize: 15, color: "gray", paddingTop: "5%", paddingBottom: "2%" }]}>
              Feedback
            </Text>

            <View style={{ flexDirection: "row", borderBottomWidth: 1 }}>
              <Icon name="contacts" style={{ fontSize: 40, paddingRight: 20 }} />
              <TextInput
                ref="textInputMobile"
