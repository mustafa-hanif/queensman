...
export default class PinVerfication extends React.Component {
    ...
    _checkCode = () => {
        ...
        Auth.confirmSignUp(username, code, {
            ...
            .catch(err => this.pinInput.current.shake().then(() => this.setState({ code: '' })));
    }
    nexthandle = () => {
    ...
    render() {
        return (
            ...
            <Content scrollEnabled={false} contentContainerStyle={styles.container} >
                ...
                <TouchableOpacity style={{ backgroundColor: "#FFCA5D", alignContent: 'center', justifyContent: 'center', height: '15%' }} onPress={this.nexthandle}>

                    <Text style={{ color: '#000E1E', fontSize: 15, fontFamily: 'Helvetica', alignSelf: 'center' }}>Next</Text>
