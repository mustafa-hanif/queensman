...
import { StyleSheet, Text, View, Dimensions, TouchableOpacity, TextInput,KeyboardAvoidingView } from 'react-native';
    ...
    nexthandle = () => {
        ...
        Auth.forgotPasswordSubmit(username, code, new_password)
            .then(data => {
                ...
                link = "http://13.250.20.151/queens_client_Apis/UpdatePassword.php?password=" + this.state.pass + "&email=" + this.state.email
                console.log(link);
    ...
    render() {
        return (
            ...
            <KeyboardAvoidingView style={styles.container} behavior="padding" enabled>
                ...
                <Text style={{ color: '#fff', fontSize: 15, fontFamily: 'Helvetica', paddingBottom: '10%' }}>Please type verification code sent to {this.state.email} via email.</Text>
                <SmoothPinCodeInput
                    ref={this.pinInput}
                    cellStyle={{
                        borderWidth: 2,
                ...
                <Text style={{ color: '#fff', fontSize: 11, fontFamily: 'Helvetica', paddingBottom: '8%' }}>*Minimum password length is 8 characters</Text>
                ...
                <View style={{ flexDirection: 'row', }}>
                    ...
                    <TextInput
                        ...
                        onChangeText={(pass) => { this.setState({ pass }); }}//email set
                    />
                ...
                <TouchableOpacity style={{ backgroundColor: "#FFCA5D", alignContent: 'center', justifyContent: 'center', height: '10%' }} onPress={this.nexthandle}>
