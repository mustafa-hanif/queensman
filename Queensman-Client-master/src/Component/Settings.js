...
import { StyleSheet, Text, View, TouchableOpacity, Image, AsyncStorage, Linking } from 'react-native';
...
class Settings extends React.Component {
  ...
  async componentWillMount() {
    ...
    link = "http://13.250.20.151/queens_client_Apis/fetchClientProfile.php?ID=" + ID
    console.log(link);
      ...
      <View style={styles.container}>
        ...
        <Content >
          <List>
            ...
            <ListItem>
              <Row>
                <Icon name="contact" style={{ fontSize: 30, color: '#718792', paddingRight: '14%', paddingTop: '3%', }}></Icon>
            ...
            <ListItem>
              <Row>
                <Icon name="phone-portrait" style={{ fontSize: 30, color: '#718792', paddingRight: '16%', paddingTop: '3%', }}></Icon>
                <View style={{ flexDirection: 'column' }}>
            ...
            <ListItem>
              <TouchableOpacity onPress={this.updatePassword}>
                <Row>
                  <Icon name="lock" style={{ fontSize: 30, color: '#718792', paddingRight: '14%', paddingTop: '3%', }}></Icon>
                  <View style={{ flexDirection: 'column' }}>
            ...
            <ListItem>
              <Row>
                <Icon name="mail" style={{ fontSize: 30, color: '#718792', paddingRight: '13%', paddingTop: '3%', }}></Icon>
                <View style={{ flexDirection: 'column' }}>
            ...
            <ListItem>
              <TouchableOpacity onPress={this.toggleFingerPrint}>
                <Row>
                  <Icon name="finger-print" style={{ fontSize: 30, color: '#718792', paddingRight: '10.5%', paddingTop: '1%', }}></Icon>
                  <View style={{ flexDirection: 'column' }}>
            ...
            <ListItem>
              <TouchableOpacity onPress={() => Linking.openURL('https://queensman.com/management-maintenance')} >
                <Row>
                  <Image source={require('../../assets/Login/Queensman_logo3.png')} style={{ height: 42, width: 42,marginRight: '13%',paddingTop: '4%' }}></Image>
            ...
            <ListItem>
              <TouchableOpacity onPress={() => Linking.openURL('https://queensman.com/terms-of-use')}>
                <Row>
                  <Icon name="clipboard" style={{ fontSize: 30, color: '#718792', paddingRight: '14%', paddingTop: '3%', paddingLeft: '1%' }}></Icon>
            ...
            <ListItem>
              <TouchableOpacity onPress={this.signOut}>
                <Row>
                  <Icon name="power" style={{ fontSize: 30, color: '#718792', paddingRight: '15%', paddingTop: '3%', paddingLeft: '1%' }}></Icon>
