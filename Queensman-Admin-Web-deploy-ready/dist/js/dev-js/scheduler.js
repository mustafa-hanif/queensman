    $(document).ready(()=>{
                        ...
                        $.get(link,function(data){
                            ...
                            $.each(data.server_response,function(index,item){
                                ...
                                if(item.schedule.time_on_calendar!==null)
                                    _time = tConvert (item.schedule.time_on_calendar.toString());
                                ...
                                var dateObj = new Date(item.schedule.date_on_calendar.toString() + ' ' + _time.toString());
        ...
        function ShowDetails(data) {
            ...
            if (res[0].services.rating != null) {
                var rating = parseInt(res[0].services.rating);
                var htmlStr = '';
