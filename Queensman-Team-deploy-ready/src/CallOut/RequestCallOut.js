...
export default class RequestCallOut extends React.Component {
    ...
    async componentWillMount() {
        ...
        link = "https://www.queensman.com/phase_2/queens_client_Apis/FetchClientSinglePropertyViaPropID.php?ID=" + property_ID
        console.log(link);
        ...
        if (this.state.picture1 == '' || this.state.Urgency == "" || this.state.JobType == 'none') {
            ...
            NetInfo.isConnected.fetch().then(isConnected => {
                if (isConnected) {
                    ...
                    link = "https://www.queensman.com/phase_2/queens_client_Apis/submitCallOut.php?client_id=" + this.state.customerID + "&prop_id=" + this.state.PropertyID + "&job=" + JOBS + "&describe=" + this.state.Description + "&urg_lvl=" + this.state.Urgency + "&picture1=" + pic1name + "&picture2=" + pic2name + "&picture3=" + pic3name + "&picture4=" + pic4name
                    console.log(link);
                    axios.get(link).then(result => {
                        console.log(result.data.server_responce)
                        ...
                        setTimeout(() => {
                            link = "https://www.queensman.com/phase_2/queens_client_Apis/fetchNewCalloutID.php?ID=" + this.state.customerID
                            console.log(link);
                            axios.get(link).then((result) => {
                                ...
                                setTimeout(() => {
                                    ...
                                    link = "https://www.queensman.com/phase_2/queens_client_Apis/fetchClientProfile.php?ID=" + this.state.customerID
                                    console.log(link);
                                    ...
                                    axios.get(link).then((result) => {
                                        ...
                                        link = "https://www.queensman.com/phase_2/queens_client_Apis/sendEmail2.php?subject=" + this.state.subject + "&callout_id=" + this.state.CalloutID + "&client_id=" + this.state.customerID + "&client_name=" + this.state.UserName + "&client_email=" + this.state.Email + "&job=" + JOBS + "&description=" + this.state.Description + "&callout_urgency=" + this.state.Urgency + "&property_id=" + this.state.PropertyID + "&property_address=" + this.state.address + "&community=" + this.state.community + "&city=" + this.state.city + "&country=" + this.state.country + "&client_phone=" + this.state.Mobile
                                        console.log(link);
                                        axios.get(link).then(result => {
