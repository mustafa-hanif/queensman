...
export default class CallOutHistoryItem extends React.Component {
  ...
  async componentWillMount() {
    ...
    var postpictures = []
    var workers = []
    link = "https://www.queensman.com/phase_2/queens_client_Apis/fetchServicePrePictures.php?callout_id=" + this.state.HistoryCallOutData.Client_property.id
    console.log(link)
    ...
    link = "https://www.queensman.com/phase_2/queens_client_Apis/fetchServicePostPictures.php?callout_id=" + this.state.HistoryCallOutData.Client_property.id
    console.log(link)
    axios.get(link).then(result => {
      var length = result.data.server_response.length
      console.log(length)
      ...
      .catch(error => console.log(error));
    link = "https://www.queensman.com/phase_2/queens_client_Apis/fetchServiceWorkers.php?callout_id=" + this.state.HistoryCallOutData.Client_property.id
    console.log(link)
    axios.get(link).then(result => {
      var length = result.data.server_response.length
      console.log(length)
  ...
  SaveResponcePress = () => {
    link = "https://www.queensman.com/phase_2/queens_client_Apis/setFeedback.php?callout_id=" + this.state.HistoryCallOutData.Client_property.id + "&rating=" + this.state.WorkRate + "&feedback=" + this.state.FeedBack
    console.log(link);
