...
export default class JobsList extends React.Component {
    ...
    async componentDidMount() {
        ...
        link = "https://www.queensman.com/phase_2/queens_worker_Apis/fetchAssignedServicesViaWorkerID.php?ID=" + this.state.workerID
        console.log(link)
        axios.get(link).then((result) => {
            ...
            if (result.data.server_response != -1) {
                this.setState({
                    ...
                    () => {
                        console.log(this.state.assignedCallouts)
                        console.log(this.state.assignedCallouts[0].service_details.client_id)
    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                {!this.state.dataAvaible ? <Text style={[styles.TextFam, { fontSize: 14, color: '#aaa', paddingTop: '3%', alignSelf: 'center' }]}>No Assigned Services</Text> :
                    <View>
                                        ...
                                        <TouchableOpacity onPress={() => this.passItem(item)}>
                                            <View style={styles.Card}>
                                                ...
                                                <View style={{ flexDirection: 'row', justifyContent: 'space-between', flex: 1, paddingBottom: '5%', }}>
                                                    ...
                                                    <Text style={[styles.TextFam, { fontSize: 9, color: '#aaa', paddingRight: '5%', alignSelf: 'center' }]}>Request time : {item.service_details.request_time}</Text>
