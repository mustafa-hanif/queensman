...
const brandPrimary = platform === PLATFORM.IOS ? '#ecb000' : '#3F51B5';
export default {
  platformStyle,
  platform,
  ...
  activeTab: platform === PLATFORM.IOS ? brandPrimary : '#fff',
  sTabBarActiveTextColor: brandPrimary,
  tabBarActiveTextColor: platform === PLATFORM.IOS ? '#2874F0' : '#fff',
  tabActiveBgColor: platform === PLATFORM.IOS ? '#cde1f9' : '#3F51B5',

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? brandPrimary : '#fff',
  ...
  toolbarBtnTextColor: platform === PLATFORM.IOS ? brandPrimary : '#fff',
  ...
  listNoteSize: 13,
  listItemSelected: platform === PLATFORM.IOS ? brandPrimary : '#3F51B5',
  ...
  segmentActiveBackgroundColor: platform === PLATFORM.IOS ? brandPrimary : '#fff',
  segmentTextColor: platform === PLATFORM.IOS ? brandPrimary : '#fff',
  segmentActiveTextColor: platform === PLATFORM.IOS ? '#fff' : '#3F51B5',
  segmentBorderColor: platform === PLATFORM.IOS ? brandPrimary : '#fff',
  ...
  topTabBarActiveTextColor: platform === PLATFORM.IOS ? brandPrimary : '#fff',
  topTabBarBorderColor: platform === PLATFORM.IOS ? '#a7a6ab' : '#fff',
  topTabBarActiveBorderColor: platform === PLATFORM.IOS ? brandPrimary : '#fff',
