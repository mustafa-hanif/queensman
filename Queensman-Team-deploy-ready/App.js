...
import { createDrawerNavigator, DrawerItems, createSwitchNavigator, createStackNavigator, createAppContainer, createMaterialTopTabNavigator } from 'react-navigation';
...
const InventoryReportStackNavigator = createStackNavigator({
  ClientList: {
    ...
    navigationOptions: ({ navigation }) => ({
      ...
      headerTintColor: '#fff',
      headerLeft: (
        <TouchableOpacity onPress={() => navigation.navigate('HomeNaviagtor')}>
          <View style={{ flexDirection: 'row' }}>
            <Text>     </Text>
...
const CustomDrawerComponent = (props) => (
  <SafeAreaView style={{ flex: 1 }}>
    <View style={{ height: 150, backgroundColor: 'white', marginTop: 30, alignItems: 'center', justifyContent: 'center' }}>
      <Image source={require('./assets/icon4.png')} style={{ height: 90, width: 150, marginBottom: 4 }}></Image>
    ...
    <View style={{ flex: 1, justifyContent: 'flex-end', paddingHorizontal: '8%', marginVertical: '0.2%' }}>
      <TouchableOpacity onPress={() => Linking.openURL('http://www.skynners.com')}>
        <Image source={require('./assets/icon.png')} style={{ height: 35, width: 150, }}></Image>
      </TouchableOpacity>
      <Text> </Text>
    </View>
  </SafeAreaView>
