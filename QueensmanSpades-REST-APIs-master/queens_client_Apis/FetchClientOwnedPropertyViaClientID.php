...
$user_ID = $_GET["ID"]; 
$mysql_qry = "SELECT property.id as property_id, property.address, property.community, property.city, property.country, property.type as category
              FROM property
              INNER JOIN property_owned ON property.id = property_owned.property_id
              WHERE property_owned.active = 1 AND property_owned.owner_id = '$user_ID';";
