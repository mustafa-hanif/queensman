...
DATE_FORMAT(callout.planned_time, '%b %d, %Y') AS planned_time,                callout.picture1, callout.picture2, callout.picture3, callout.picture4 , callout.urgency_level, callout.action, job.rating, job.feedback, job.signature, job.instructions, job.solution, 
                property.address,property.community,property.city,property.country, client.id as client_id, client.email as client_username, client.full_name as client_name
                FROM callout 
