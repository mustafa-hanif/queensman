...
header('Content-Type: application/json');
    ...
    $target_file_abs = "http://13.250.20.151/queens_client_Apis/reports/".$target_file;

    // Deleting image link from database
    $mysql_qry2 = "DELETE FROM material_warranty_report WHERE property_id = '$property_id' and report_location = '$target_file_abs';";
