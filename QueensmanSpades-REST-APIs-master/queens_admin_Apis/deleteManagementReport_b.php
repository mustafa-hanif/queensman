...
header('Content-Type: application/json');
    ...
    $mysql_qry2 = "DELETE FROM management_report WHERE property_id = '$property_id' and report_location = '$target_file_abs';";
...
//	echo json_encode(array("server_response"=>"The report hasn't been deleted from the database correctly"));
