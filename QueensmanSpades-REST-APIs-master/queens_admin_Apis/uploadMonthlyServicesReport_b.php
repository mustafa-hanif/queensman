...
$mysql_qry = "INSERT INTO monthly_services_report(property_id, owner_id, report_upload_date, report_location) VALUES ('$user_prop_ID', '$user_ID', '$report_date', '$report_location');";
