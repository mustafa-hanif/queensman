...
header('Content-Type: application/json');
    ...
    $target_file_abs = "http://www.queensman.com/queens_worker_Apis/pre_photos/".$target_file;

    // Uploading image link to database
    $mysql_qry2 = "INSERT INTO pre_job_picture(callout_id, picture_location) VALUES('$callout_id','$target_file_abs');";
