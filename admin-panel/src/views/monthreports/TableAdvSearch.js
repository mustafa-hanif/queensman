    ...
    <Fragment>
      <Card>
        <CardHeader className='border-bottom'>
          <CardTitle tag='h4'>Monthly Reports</CardTitle>
        ...
        <CardBody>
          <Row form className='mt-1 mb-50'>
            ...
            <Col lg='4' md='6'>
              <FormGroup>
                <Label for='occupation'>Select Month:</Label>
                <Input type="date" id='occupation' placeholder='Month' value={searchOccupation} onChange={handleOccupationFilter} />
              </FormGroup>
            </Col>
            <Col lg='4' md='6'>
              <FormGroup>
              <Button.Ripple className="col-md-8" color='primary' >
            GENERATE
          </Button.Ripple>
              </FormGroup>
            </Col>
