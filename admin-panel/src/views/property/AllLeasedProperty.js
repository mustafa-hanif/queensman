...
const advSearchColumns = [
    ...
    {
        name: 'Properties',
        selector: 'client.leases_aggregate.aggregate.count',
        sortable: true,
        minWidth: '100px',
        center: true,
        cell: row => {
            return (
                <>
                <Badge color={'light-info mx-auto '} pill>{row.client.leases_aggregate.aggregate.count}</Badge>
                </>
            )
        }
      }
  ...
  return (
    <Fragment>
      ...
      <CardHeader className='border-bottom'>
          <CardTitle tag='h4'>Search Leased Properties</CardTitle>
